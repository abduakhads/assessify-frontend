...
export default function ActivationPage() {
  ...
  useEffect(() => {
    const activateAccount = async () => {
      ...
      // Extract uid and token from URL like /auth/activate/MzY/ctrxxh-2ad03b41eb491d9252d0525a1beed5e6
      const uid = pathSegments[3]; // MzY
      const token = pathSegments[4]; // ctrxxh-2ad03b41eb491d9252d0525a1beed5e6
